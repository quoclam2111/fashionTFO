...
import adapters.order.OderController;
...
public class FormGUI extends JFrame {
    ...
    private OrderDetailDTO currentOrderDetail;
    ...
    public FormGUI(List<ProductVariantDTO> cartItems) {
        ...
        btnConfirm.addActionListener((ActionEvent e) -> {
            if (currentOrderDetail != null) {
                ...
                PaymentMethodFormGUI methodForm = new PaymentMethodFormGUI(currentOrderDetail);
