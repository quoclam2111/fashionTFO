...
public class HomeView extends JFrame implements IHomeView {
    ...
    private void createHeader() {
        ...
        // Logo and Title
        JLabel titleLabel = new JLabel("🛍️ FASHION STORE");
    ...
    private void createMenu() {
        ...
        // Customer Buttons (Hidden by default)
        btnCheckout = createMenuButton("💳 Thanh Toán", new Color(230, 126, 34));
        btnCheckout.addActionListener(e -> controller.handleCheckout());
        ...
        JLabel adminTitle = new JLabel("⚙️ ADMIN");
