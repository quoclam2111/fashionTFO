...
<head>
    ...
    <title>Chỉnh sửa sản phẩm - Fashion Store</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    ...
    <div class="main-content">
        <div class="page-header">
            ...
            <a href="${pageContext.request.contextPath}/admin/products?action=view&id=<%= product != null ? product.productId : "" %>" 
               class="btn-back">
                ← Quay lại
            </a>
        </div>
                ...
                <form method="post" action="${pageContext.request.contextPath}/admin/products">
                    ...
                    <div class="form-group full-width">
                        ...
                        <textarea id="description" name="description" 
                                  placeholder="Nhập mô tả sản phẩm"><%= product.description != null ? product.description : "" %></textarea>
                    </div>
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="text" id="brandId" name="brandId" 
                                   value="<%= product.brandId != null ? product.brandId : "" %>"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="categoryId" name="categoryId" 
                                   value="<%= product.categoryId != null ? product.categoryId : "" %>"
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="defaultImage" name="defaultImage" 
                               value="<%= product.defaultImage != null ? product.defaultImage : "" %>"
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" id="discountPrice" name="discountPrice" min="0" step="1000"
                                   value="<%= product.discountPrice != null ? product.discountPrice : "" %>"
                                   placeholder="450000">
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group">
                            ...
                            <select id="status" name="status" required>
                                <option value="PUBLISHED" <%= "PUBLISHED".equals(product.status) ? "selected" : "" %>>
                                    Đã xuất bản
                                </option>
                                <option value="DRAFT" <%= "DRAFT".equals(product.status) ? "selected" : "" %>>
                                    Bản nháp
                                </option>
                                <option value="ARCHIVED" <%= "ARCHIVED".equals(product.status) ? "selected" : "" %>>
                                    Đã lưu trữ
                                </option>
                            </select>
                        </div>
